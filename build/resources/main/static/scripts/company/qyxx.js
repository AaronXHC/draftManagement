window.onload=function(){
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $.each(data.result, function (index, item) {
                                        html += "<tr><td>" + item.xm + "</td><td>" + item.sfzjhm + "</td><td>" + item.hmdzw + "</td><td onclick='tc("+item.sfzjhm+")'>" + item.rzhmdqygs +
                                            "</td><td onclick='tc("+item.sfzjhm+")'>" + item.zcqyrzgs + "</td><td>" + item.dh + "</td><td>" + item.nsrmc + "</td><td>" + item.nsrsbh +
                                            "</td><td>" + item.shxydm + "</td><td>" + item.swjgmc2 + "</td><td>" + item.swjgmc + "</td><td>" + item.swryxm + "</td><td>" +
                                            item.djrq + "</td><td>" + item.fddbrxm + "</td><td>" +item.fddbrsfzjhm  + "</td><td>" + item.cwfzrxm + "</td><td>" +item.cwfzrsfzjhm  + "</td>" +
                                            "<td>" + item.bsrxm + "</td><td>" +item.bsrsfzjhm  + "</td><td>" + item.gprxm + "</td><td>" +item.gprsfzjhm  + "</td></tr>";
                                    });
    ...
    $('#export').click(function () {
        ...
        var url="http://127.0.0.1:8180/export/hmdExcel";
...
function tc(sfzjhm) {
    ...
    var url="http://127.0.0.1:8180/export/hmdExcel?sfzjhm="+sfzjhm;
