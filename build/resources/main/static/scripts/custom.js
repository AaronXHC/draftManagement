...
function handleHash_(o,v) {
	...
	if(!optionStr){
		...
		$.each(optionArr,function(i,itemStr){
			...
			if(itemArr[0] == 'tel' || itemArr[0] == 'email' || itemArr[0] == 'mark' || itemArr[0] == 'patent' || itemArr[0] == 'finance' || itemArr[0] == 'listed' || itemArr[0] == 'shixin' || itemArr[0] == 'zzq' || itemArr[0] == 'rjzzq'){
				tel_email++;
			}
	...
	if(o == 'tel' || o == 'email' || o == 'mark' || o == 'patent' || o == 'finance' || o == 'listed' || o == 'shixin' || o == 'zzq' || o == 'rjzzq'){
		if(tel_email == 5){
...
function updateDesc(type){
    ...
    var hideFlag = true;//默认隐藏
    if(type == 1){
        var arr = ['index','searchType','coyType','statusCode','registfund','startDate','province','city','county','industrycode','subindustrycode','thirdindustrycode','tel','email','mark','patent','finance','listed','shixin','zzq','rjzzq','insured'];
    }else if(type == 2){
