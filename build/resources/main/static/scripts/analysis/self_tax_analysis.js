...
$(document).ready(function(){
   commonUtil.getZtree("/common/getHY","treeDemo_HY");
    ...
    commonUtil.getZtree("/common/getZSXM","treeDemo_ZSXM");
    commonUtil.getZtree("/common/getZSPM","treeDemo_ZSPM");
    commonUtil.getZtree("/common/getSKZL","treeDemo_SKZL");

    commonUtil.getZtree("/common/getTZLX","treeDemo_TZLX");
    commonUtil.getZtree("/common/getSKSX","treeDemo_SKSX");
...
$("#ZSXM").focus(function () {
    $("#menuContent_ZSXM").show();
});
$("#ZSPM").focus(function () {
    $("#menuContent_ZSPM").show();
});

$("#SKZL").focus(function () {
    $("#menuContent_SKZL").show();
});

$("#TZLX").focus(function () {
    $("#menuContent_TZLX").show();
});

$("#SKSX").focus(function () {
    $("#menuContent_SKSX").show();
});
...
$(document).click(function () {
    ...
    $("#menuContent_HY").hide();
    $("#menuContent_ZSXM").hide();
    $("#menuContent_ZSPM").hide();
    $("#menuContent_SKZL").hide();
    $("#menuContent_TZLX").hide();
    $("#menuContent_SKSX").hide();
});
...
$("#menuContent_ZSXM").click(function (event) {
    event.stopPropagation();
});
$("#menuContent_ZSPM").click(function (event) {
    event.stopPropagation();
});
$("#menuContent_SKZL").click(function (event) {
    event.stopPropagation();
});
$("#menuContent_TZLX").click(function (event) {
    event.stopPropagation();
});
$("#menuContent_SKSX").click(function (event) {
    event.stopPropagation();
});
...
$("#ZSXM").click(function (event) {
    event.stopPropagation();
});
$("#ZSPM").click(function (event) {
    event.stopPropagation();
});

$("#SKZL").click(function (event) {
    event.stopPropagation();
});
$("#TZLX").click(function (event) {
    event.stopPropagation();
});
$("#SKSX").click(function (event) {
    event.stopPropagation();
});
 ...
 * 获取调账类型
 */
// commonUtil.getSelectData("/common/getTZLX","TZLX");
...
$("#export").click(function () {
    if(btxy()){
        ...
        var url="/export/analysisTaxExcel";
...
function getSearchParams(){
    ...
    var rkrq_start=$("#rkrq_start").val();
    var rkrq_end=$("#rkrq_end").val();
    var skzl_dm=$("#SKZL_DM").val();
    var sksx_dm=$("#SKSX_DM").val();
    var zsxm_dm=$("#ZSXM_DM").val();
    var zspm_dm=$("#ZSPM_DM").val();
    var zszm_dm=$("#ZSZM").val();
